...
import 'package:azan/presentation/pages/settings/app/components/locale_dropdown.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButton<String>(
              ...
              value: _countries.any((c) => c.isoCode == _selectedCountry)
                  ? _selectedCountry
                  : null,
              items: _countries
            ...
            DropdownButton<String>(
              ...
              value: _states.any((s) => s.isoCode == _selectedState)
                  ? _selectedState
                  : null,
              items: _states
            ...
            Center(
              child: ElevatedButton(
                onPressed: () {
                  ...
                  context.read<ContentBloc>().add(LoadContentList(locale.languageCode));
