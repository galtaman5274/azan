...
class _SetupPageState extends State<SetupPage> {
  ...
  Widget build(BuildContext context) {
    String _asrText = _asrCalculationMethods[0];
    return Scaffold(
      appBar: AppBar(
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButton<String>(
              ...
              onChanged: (value) {
                setState(() {
                  value == _asrCalculationMethods[0]
                      ? _asrMethod = Madhab.hanafi
                      : _asrMethod = Madhab.shafi;
                });
              },
            ),
            const SizedBox(height: 20),
  ...
  Future<void> _saveSettingsAndNavigate() async {
    if (_latitude.isNotEmpty && _longitude.isNotEmpty) {
      ...
      await _storage.write(
          ...
          value: CalculationMethod.values
              .indexOf(_selectedCalculationMethod)
              .toString());
      await _storage.write(
          key: 'asrMethod',
          value: Madhab.values.indexOf(_asrMethod).toString());
      print(Madhab.values.indexOf(_asrMethod).toString());
